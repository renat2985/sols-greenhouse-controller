...
| P2-3 | IO7 | Реле приточного вентилятора или подсветки рассады |
...
| IO7 | Intake / grow light relay | Приточный вентилятор или лампа для рассады, если `relay2_mode=light` |

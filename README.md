...
- Sends telemetry to [sols.lv](https://sols.lv).
- Shows a QR code for cloud dashboard and local setup.
- Controls three relays:
  - exhaust fan,
  - intake fan,
  - water valve or pump.
- Supports indoor and outdoor climate comparison.
...
- JC3248W535 ESP32-S3 touch display
- 320x480 display
...
- Indoor: AHT20 + BMP280 I2C module
- Outdoor: SHT40 I2C module
